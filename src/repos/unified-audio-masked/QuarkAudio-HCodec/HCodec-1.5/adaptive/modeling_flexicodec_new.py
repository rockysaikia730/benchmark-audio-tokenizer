...
class FlexiCodec(nn.Module):
    ...
    @staticmethod
    def _perform_similarity_alignment_vectorized(h_frames_v: torch.Tensor, x_lens=None, current_threshold=1.0, max_tokens_per_group=8):
        """
        ...
        if max_tokens_per_group is not None:
            ...
            is_split_boundary = (frame_indices_in_segment % max_tokens_per_group) == 0
